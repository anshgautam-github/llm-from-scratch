# For the finetuning process itself, we can reuse the loss calculation and training functions implemented during the pretraining:
...
# Finally, let's take a look at the training and validation loss curvesimport matplotlib.pyplot as plt
